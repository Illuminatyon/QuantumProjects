#!/usr/bin/env python
"""
launcher.py - Launcher script for the Quantum Circuit Simulator

This script launches the Quantum Circuit Simulator using the correct Streamlit command.
...
def main():
    """
    Launch the Quantum Circuit Simulator using Streamlit.
    """
    print("Launching Quantum Circuit Simulator...")
    ...
    cmd = [sys.executable, "-m", "streamlit", "run", main_file]
