#!/usr/bin/env python
"""
launcher.py - Launcher script for the Entanglement Visualizer

This script launches the Entanglement Visualizer using the correct Streamlit command.
...
def main():
    """
    Launch the Entanglement Visualizer using Streamlit.
    """
    print("Launching Entanglement Visualizer...")
